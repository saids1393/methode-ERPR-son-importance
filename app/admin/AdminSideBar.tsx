  ...
  return (
    <>
      ...
      <aside className={`
        ...
        w-64 bg-zinc-800 border-r border-zinc-700 flex flex-col
      `}>
        {/* Header */}
        <div className="p-6 border-b border-zinc-700">
          <Link href="/admin" className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Méthode ERPR</p>
            </div>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-zinc-700">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 px-3 py-2 text-zinc-300 hover:bg-zinc-700 hover:text-white rounded-lg transition-all duration-200"
          >
