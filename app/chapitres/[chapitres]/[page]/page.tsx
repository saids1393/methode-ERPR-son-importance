// app/chapitres/[chapitres]/[page]/page.tsx
...
async function getComponent(chapitres: string, page: string) {
  try {
    const module = await import(`@/app/components/chapitres/chapitre${chapitres}/Page${page}`);
          ...
          <div className="text-center p-8">
            ...
            {pageInfo ? (
              <div className="text-gray-400 mb-4">
                ...
                <p className="mb-2">
                  mais le composant n'a pas encore été créé.
                </p>
              </div>
            ) : (
...
// Génération automatique des static params depuis lib/chapters.tsx
