...
const Page12 = () => {
  ...
  const letterGroups = [
    ...
    { letter: 'ب', name: 'بَاء', vowels: ['بً', 'بٌ', 'بٍ'] },
    { letter: 'ت', name: 'تَاء', vowels: ['تً', 'تٌ', 'تٍ'] },
    { letter: 'ث', name: 'ثَاء', vowels: ['ثً', 'ثٌ', 'ثٍ'] },
    { letter: 'ج', name: 'جِيم', vowels: ['جً', 'جٌ', 'جٍ'] },
    { letter: 'ح', name: 'حَاء', vowels: ['حً', 'حٌ', 'حٍ'] },
    { letter: 'خ', name: 'خَاء', vowels: ['خً', 'خٌ', 'خٍ'] },
    ...
    { letter: 'س', name: 'سِين', vowels: ['سً', 'سٌ', 'سٍ'] },
    { letter: 'ش', name: 'شِين', vowels: ['شً', 'شٌ', 'شٍ'] },
    { letter: 'ص', name: 'صَاد', vowels: ['صً', 'صٌ', 'صٍ'] },
    { letter: 'ض', name: 'ضَاد', vowels: ['ضً', 'ضٌ', 'ضٍ'] },
    { letter: 'ط', name: 'طَاء', vowels: ['طً', 'طٌ', 'طٍ'] },
    { letter: 'ظ', name: 'ظَاء', vowels: ['ظً', 'ظٌ', 'ظٍ'] },
    { letter: 'ع', name: 'عَين', vowels: ['عً', 'عٌ', 'عٍ'] },
    { letter: 'غ', name: 'غَين', vowels: ['غً', 'غٌ', 'غٍ'] },
    { letter: 'ف', name: 'فَاء', vowels: ['فً', 'فٌ', 'فٍ'] },
    { letter: 'ق', name: 'قَاف', vowels: ['قً', 'قٌ', 'قٍ'] },
    { letter: 'ك', name: 'كَاف', vowels: ['كً', 'كٌ', 'كٍ'] },
    { letter: 'ل', name: 'لَام', vowels: ['لً', 'لٌ', 'لٍ'] },
    { letter: 'م', name: 'مِيم', vowels: ['مً', 'مٌ', 'مٍ'] },
    { letter: 'ن', name: 'نُون', vowels: ['نً', 'نٌ', 'نٍ'] },
    { letter: 'ه', name: 'هَاء', vowels: ['هً', 'هٌ', 'هٍ'] },
    { letter: 'و', name: 'وَاو', vowels: ['وً', 'وٌ', 'وٍ'] },
    { letter: 'ي', name: 'يَاء', vowels: ['يً', 'يٌ', 'يٍ'] },
