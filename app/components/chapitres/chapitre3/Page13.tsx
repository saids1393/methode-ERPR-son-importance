      ...
      <div className="w-full h-full bg-zinc-900 overflow-hidden">
        ...
        <div className="bg-arabic-gradient text-white p-6 text-center">
          ...
          <div className="bg-white/10 px-6 py-3 rounded-full text-lg font-semibold backdrop-blur-sm border border-white/20 inline-block">
            تَعَلُّمُ الْحُرُوفِ الْعَرَبِيَّةِ مَعَ التَّنْوِينِ فِي بِدَايَةِ الْكَلِمَةِ
          </div>
          <div className="text-sm mt-2 opacity-90">
            الشَّكْلُ الْأَوَّلِيُّ مَعَ الْحَرَكَاتِ الْمُضَاعَفَةِ
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-zinc-800 to-zinc-700 text-white p-5 flex justify-between items-center">
          <div className="text-lg font-semibold">الحروف في بداية الكلمة - التنوين</div>
...
// TanwinInitialGroup Component pour chaque groupe de lettre avec ses 3 tanwins
const TanwinInitialGroup = ({ letter, name, vowels, tanwinNames, emphatic, nonConnecting }: { 
  letter: string; 
  name: string; 
  vowels: string[];
  tanwinNames: string[];
