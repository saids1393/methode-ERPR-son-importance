...
const chapter3Page14AudioMappings: { [key: string]: string } = {
  ...
  'ـاً': 'chap3_pg12_case1',
  'ـاٌ': 'chap3_pg12_case2',
  'ـاٍ': 'chap3_pg12_case3',
  
  // Ba avec voyelles doubles (milieu)
  'ـبًـ': 'chap3_pg12_case4',
  'ـبٌـ': 'chap3_pg12_case5',
  'ـبٍـ': 'chap3_pg12_case6',
  
  // Ta avec voyelles doubles (milieu)
  'ـتًـ': 'chap3_pg12_case7',
  'ـتٌـ': 'chap3_pg12_case8',
  'ـتٍـ': 'chap3_pg12_case9',
  
  // Tha avec voyelles doubles (milieu)
  'ـثًـ': 'chap3_pg12_case10',
  'ـثٌـ': 'chap3_pg12_case11',
  'ـثٍـ': 'chap3_pg12_case12',
  
  // Jim avec voyelles doubles (milieu)
  'ـجًـ': 'chap3_pg12_case13',
  'ـجٌـ': 'chap3_pg12_case14',
  'ـجٍـ': 'chap3_pg12_case15',
  
  // Ha avec voyelles doubles (milieu)
  'ـحًـ': 'chap3_pg12_case16',
  'ـحٌـ': 'chap3_pg12_case17',
  'ـحٍـ': 'chap3_pg12_case18',
  
  // Kha avec voyelles doubles (milieu)
  'ـخًـ': 'chap3_pg12_case19',
  'ـخٌـ': 'chap3_pg12_case20',
  'ـخٍـ': 'chap3_pg12_case21',
  
  // Dal avec voyelles doubles (finale)
  'ـدً': 'chap3_pg12_case22',
  'ـدٌ': 'chap3_pg12_case23',
  'ـدٍ': 'chap3_pg12_case24',
  
  // Dhal avec voyelles doubles (finale)
  'ـذً': 'chap3_pg12_case25',
  'ـذٌ': 'chap3_pg12_case26',
  'ـذٍ': 'chap3_pg12_case27',
  
  // Ra avec voyelles doubles (finale)
  'ـرً': 'chap3_pg12_case28',
  'ـرٌ': 'chap3_pg12_case29',
  'ـرٍ': 'chap3_pg12_case30',
  
  // Zay avec voyelles doubles (finale)
  'ـزً': 'chap3_pg12_case31',
  'ـزٌ': 'chap3_pg12_case32',
  'ـزٍ': 'chap3_pg12_case33',
  
  // Sin avec voyelles doubles (milieu)
  'ـسًـ': 'chap3_pg12_case34',
  'ـسٌـ': 'chap3_pg12_case35',
  'ـسٍـ': 'chap3_pg12_case36',
  
  // Shin avec voyelles doubles (milieu)
  'ـشًـ': 'chap3_pg12_case37',
  'ـشٌـ': 'chap3_pg12_case38',
  'ـشٍـ': 'chap3_pg12_case39',
  
  // Sad avec voyelles doubles (milieu)
  'ـصًـ': 'chap3_pg12_case40',
  'ـصٌـ': 'chap3_pg12_case41',
  'ـصٍـ': 'chap3_pg12_case42',
  
  // Dad avec voyelles doubles (milieu)
  'ـضًـ': 'chap3_pg12_case43',
  'ـضٌـ': 'chap3_pg12_case44',
  'ـضٍـ': 'chap3_pg12_case45',
  
  // Ta emphatic avec voyelles doubles (milieu)
  'ـطًـ': 'chap3_pg12_case46',
  'ـطٌـ': 'chap3_pg12_case47',
  'ـطٍـ': 'chap3_pg12_case48',
  
  // Dha emphatic avec voyelles doubles (milieu)
  'ـظًـ': 'chap3_pg12_case49',
  'ـظٌـ': 'chap3_pg12_case50',
  'ـظٍـ': 'chap3_pg12_case51',
  
  // Ayn avec voyelles doubles (milieu)
  'ـعًـ': 'chap3_pg12_case52',
  'ـعٌـ': 'chap3_pg12_case53',
  'ـعٍـ': 'chap3_pg12_case54',
  
  // Ghayn avec voyelles doubles (milieu)
  'ـغًـ': 'chap3_pg12_case55',
  'ـغٌـ': 'chap3_pg12_case56',
  'ـغٍـ': 'chap3_pg12_case57',
  
  // Fa avec voyelles doubles (milieu)
  'ـفًـ': 'chap3_pg12_case58',
  'ـفٌـ': 'chap3_pg12_case59',
  'ـفٍـ': 'chap3_pg12_case60',
  
  // Qaf avec voyelles doubles (milieu)
  'ـقًـ': 'chap3_pg12_case61',
  'ـقٌـ': 'chap3_pg12_case62',
  'ـقٍـ': 'chap3_pg12_case63',
  
  // Kaf avec voyelles doubles (milieu)
  'ـكًـ': 'chap3_pg12_case64',
  'ـكٌـ': 'chap3_pg12_case65',
  'ـكٍـ': 'chap3_pg12_case66',
  
  // Lam avec voyelles doubles (milieu)
  'ـلًـ': 'chap3_pg12_case67',
  'ـلٌـ': 'chap3_pg12_case68',
  'ـلٍـ': 'chap3_pg12_case69',
  
  // Mim avec voyelles doubles (milieu)
  'ـمًـ': 'chap3_pg12_case70',
  'ـمٌـ': 'chap3_pg12_case71',
  'ـمٍـ': 'chap3_pg12_case72',
  
  // Nun avec voyelles doubles (milieu)
  'ـنًـ': 'chap3_pg12_case73',
  'ـنٌـ': 'chap3_pg12_case74',
  'ـنٍـ': 'chap3_pg12_case75',
  
  // Ha avec voyelles doubles (milieu)
  'ـهًـ': 'chap3_pg12_case76',
  'ـهٌـ': 'chap3_pg12_case77',
  'ـهٍـ': 'chap3_pg12_case78',
  
  // Waw avec voyelles doubles (finale)
  'ـوً': 'chap3_pg12_case79',
  'ـوٌ': 'chap3_pg12_case80',
  'ـوٍ': 'chap3_pg12_case81',
  
  // Ya avec voyelles doubles (milieu)
  'ـيًـ': 'chap3_pg12_case82',
  'ـيٌـ': 'chap3_pg12_case83',
  'ـيٍـ': 'chap3_pg12_case84'
};
