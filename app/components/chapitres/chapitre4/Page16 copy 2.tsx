...
const Page16 = () => {
  ...
  const disconnectedLetters = [
    ...
    { letter: 'د', example: 'عُدْنَ', meaning: 'revenez !', startPercent: 35, widthPercent: 30, color: '#ff0000ff' },
    { letter: 'ذ', example: 'يَذْكُرُ', meaning: 'il se souvient', startPercent: 55, widthPercent: 27, color: '#ff0000ff' },
    { letter: 'ر', example: 'فَرِحَ', meaning: 'il s’est réjoui', startPercent: 42, widthPercent: 35, color: '#ff0000ff' },
