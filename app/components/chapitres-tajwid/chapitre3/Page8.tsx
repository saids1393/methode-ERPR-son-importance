    ...
    <div className="p-4 md:p-8 bg-gray-900">
      <div className="w-full bg-gray-800 rounded-lg p-6 md:p-8">
        <div className="text-white space-y-6 text-lg md:text-xl leading-relaxed">
          <h2 className="text-3xl font-bold text-purple-400 mb-4">Ikhfâ' Shafawî (الإخفاء الشفوي)</h2>
          
          <p>
            L'<span className="text-purple-400 font-semibold">Ikhfâ' Shafawî</span> signifie "dissimulation labiale". 
            Cette règle s'applique quand le <span className="text-green-400 font-semibold">Mîm Sâkin (مْ)</span> est suivi 
            de la lettre <span className="text-amber-400 font-semibold">Bâ' (ب)</span>.
          </p>
          
          <div className="text-center my-6">
            <div className="inline-block bg-purple-900/50 border-2 border-purple-500 rounded-xl p-6">
              <p className="text-gray-300 text-lg mb-2">La règle :</p>
              <p className="text-4xl text-purple-400 font-bold">مْ + ب = إخفاء شفوي</p>
            </div>
          </div>
          
          <p>
            Dans ce cas, le Mîm est prononcé de manière <span className="text-purple-400 font-semibold">dissimulée</span> (ni complètement claire, ni fusionnée) 
            avec une <span className="text-amber-400 font-semibold">Ghunna (nasalité)</span> maintenue pendant 2 temps.
          </p>
          
          <div className="bg-purple-900/30 border border-purple-500/50 rounded-lg p-4 md:p-6 my-6">
            <p>
              💡 <span className="font-semibold">Comment prononcer :</span> Rapprochez les lèvres sans les fermer complètement, 
              puis laissez passer un son nasal (Ghunna) pendant 2 temps avant de prononcer le Bâ'.
            </p>
          </div>
          
          <p>
            Cette règle est appelée "Shafawî" (labiale) car elle implique les deux lèvres dans la prononciation.
          </p>
        </div>
      </div>
      
      <div className="px-4 md:px-8">
        <PageNavigation currentChapter={3} currentPage={8} module="TAJWID" className="mt-6 mb-4" />
      </div>

      <footer className="border-t-1 text-white text-center p-4 md:p-6 mt-8 flex-shrink-0 font-semibold text-base md:text-lg">
        <div>Chapitre 3 - Page 8</div>
...
// Données des exemples pour le slider - Ikhfâ' Shafawî (مْ + ب)
const examplesData = [
  { 
    letter: 'ب', 
    verse: 'تَرْمِيهِم بِحِجَارَةٍ',
    translation: 'Les jeter avec des pierres',
    surah: 105,
    ayah: 4
  },
  { 
    letter: 'ب', 
    verse: 'يَعْتَصِم بِاللَّهِ',
    translation: "S'attacher à Allah",
    surah: 3,
    ayah: 101
  },
  { 
    letter: 'ب', 
    verse: 'هُم بِرَبِّهِمْ',
    translation: 'Ils sont envers leur Seigneur',
    surah: 2,
    ayah: 4
  },
  { 
    letter: 'ب', 
    verse: 'أَنتُم بِهِ',
    translation: 'Vous en lui',
    surah: 2,
    ayah: 85
  },
  { 
    letter: 'ب', 
    verse: 'وَمَا هُم بِمُؤْمِنِينَ',
    translation: 'Et ils ne sont pas croyants',
    surah: 2,
    ayah: 8
  },
  { 
    letter: 'ب', 
    verse: 'رَبِّهِم بِالْغَيْبِ',
    translation: "Leur Seigneur dans l'invisible",
    surah: 67,
    ayah: 12
  }
];
          ...
          {reciters.map((reciter) => (
            <button
              ...
              className={`w-full px-4 py-3 text-left hover:bg-gray-700 transition-colors flex flex-col ${
                selectedReciter === reciter.id ? 'bg-purple-900/50' : ''
              }`}
            >
  ...
  return (
    <div className="p-2 md:p-4 lg:p-8 bg-gray-900">
      ...
      <footer className="border-t-1 text-white text-center p-4 md:p-6 flex-shrink-0 font-semibold text-sm md:text-base">
        <div>Chapitre 3 - Page 8 : Ikhfâ' Shafawî</div>
        <div className="mt-1">© 2025 Tous droits réservés</div>
      </footer>
    </div>
  );
...
const Page8 = () => {
  ...
  const pageTitle = currentPage === 0 
    ? "Leçon : Ikhfâ' Shafawî (الإخفاء الشفوي)"
    : "Exemples d'Ikhfâ' Shafawî";
