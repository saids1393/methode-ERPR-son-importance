    ...
    <div className="p-4 md:p-8 bg-gray-900">
      <div className="w-full bg-gray-800 rounded-lg p-6 md:p-8">
        <div className="text-white space-y-6 text-lg md:text-xl leading-relaxed">
          <h2 className="text-3xl font-bold text-blue-400 mb-4">Madd Ṭabî'î (المد الطبيعي) - Madd Naturel</h2>
          
          <p>
            Le <span className="text-blue-400 font-semibold">Madd Ṭabî'î</span> (aussi appelé Madd Aslî - المد الأصلي) 
            est le prolongement <span className="text-amber-400 font-semibold">naturel et fondamental</span>. 
            Il constitue la base de tous les autres types de Madd.
          </p>
          ...
          <div className="text-center my-6">
            <div className="inline-block bg-blue-900/50 border-2 border-blue-500 rounded-xl p-6">
              ...
              <p className="text-5xl text-blue-400 font-bold">2 temps (حركتان)</p>
            </div>
          </div>
          
          <p>
            <span className="text-green-400 font-semibold">Condition :</span> Le Madd Ṭabî'î s'applique quand une lettre de Madd 
            (ا، و، ي) n'est suivie <span className="text-red-400 font-semibold">ni d'une Hamza (ء) ni d'un Sukûn (ْ)</span>.
          </p>
          
          <div className="bg-blue-900/30 border border-blue-500/50 rounded-lg p-4 md:p-6 my-6">
            <p>
              💡 <span className="font-semibold">Pourquoi "naturel" ?</span> Parce que c'est la durée minimale et instinctive 
              nécessaire pour prononcer correctement la lettre de Madd. Sans cette prolongation de 2 temps, 
              la lettre ne serait pas prononcée correctement.
            </p>
          </div>
          
          <p>
            Ce Madd est <span className="text-purple-400 font-semibold">obligatoire</span> et sa durée est 
            <span className="text-purple-400 font-semibold"> fixe (2 temps)</span> - ni plus, ni moins.
          </p>
        </div>
      </div>
      
      <div className="px-4 md:px-8">
        <PageNavigation currentChapter={4} currentPage={12} module="TAJWID" className="mt-6 mb-4" />
      </div>

      <footer className="border-t-1 text-white text-center p-4 md:p-6 mt-8 flex-shrink-0 font-semibold text-base md:text-lg">
        <div>Chapitre 4 - Page 12</div>
...
// Données des exemples pour le slider - Madd Ṭabî'î
const examplesData = [
  { 
    letter: 'ا', 
    verse: 'قَالَ',
  ...
  return (
    <div className="p-2 md:p-4 lg:p-8 bg-gray-900">
      ...
      <footer className="border-t-1 text-white text-center p-4 md:p-6 flex-shrink-0 font-semibold text-sm md:text-base">
        <div>Chapitre 4 - Page 12 : Madd Ṭabî'î</div>
        <div className="mt-1">© 2025 Tous droits réservés</div>
      </footer>
    </div>
  );
...
const Page13 = () => {
  ...
  const pageTitle = currentPage === 0 
    ? "Leçon : Madd Ṭabî'î (المد الطبيعي)"
    : "Exemples de Madd Ṭabî'î";
