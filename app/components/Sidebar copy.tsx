...
export default function Sidebar() {
  ...
  // Vérifie si un chapitre est complètement terminé
  const isChapterCompleted = (chapter: typeof chapters[0]) => {
    return chapter.pages.every(page => completedPages.has(page.pageNumber));
  };

  return (
    <aside className="w-72 h-screen bg-gradient-to-b from-zinc-900 to-zinc-800 text-zinc-100 fixed left-0 top-0 flex flex-col border-r border-zinc-700 shadow-xl">
      {/* Header */}
