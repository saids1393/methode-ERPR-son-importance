...
export const useRealProgressChartTajwid = () => {
  ...
  useEffect(() => {
    const fetchProgressData = async () => {
      try {
        ...
        // Appeler l'API avec le module TAJWID
        const response = await fetch('/api/progress/history?module=TAJWID', {
          method: 'GET',
          cache: 'no-store',
          headers: {
...
export default useRealProgressChartTajwid;
